...
-- application_test.csv (121 kolon)
DROP TABLE IF EXISTS raw.application_test;
CREATE TABLE raw.application_test (
    sk_id_curr                    BIGINT,
...
-- application_train.csv (122 kolon)
...
-- bureau_balance.csv (3 kolon)
DROP TABLE IF EXISTS raw.bureau_balance;
CREATE TABLE raw.bureau_balance (
    sk_id_bureau    BIGINT,
    months_balance  BIGINT,
    status          TEXT
);

-- credit_card_balance.csv (23 kolon)
DROP TABLE IF EXISTS raw.credit_card_balance;
CREATE TABLE raw.credit_card_balance (
    sk_id_prev                  BIGINT,
    sk_id_curr                  BIGINT,
    months_balance              BIGINT,
...
-- installments_payments.csv (8 kolon)
...
-- POS_CASH_balance.csv (8 kolon)
DROP TABLE IF EXISTS raw.pos_cash_balance;
CREATE TABLE raw.pos_cash_balance (
    sk_id_prev             BIGINT,
    sk_id_curr             BIGINT,
    months_balance         BIGINT,
...
-- previous_application.csv (37 kolon)
DROP TABLE IF EXISTS raw.previous_application;
CREATE TABLE raw.previous_application (
    sk_id_prev                   BIGINT,
    sk_id_curr                   BIGINT,
    name_contract_type           TEXT,
    amt_annuity                  DOUBLE PRECISION,
